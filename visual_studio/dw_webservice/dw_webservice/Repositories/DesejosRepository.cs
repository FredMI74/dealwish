...
{
    public class DesejosRepository 
    {
        IConfiguration configuration;
        public DesejosRepository(IConfiguration _configuration)
        {
        ...
        public object Consultar_desejo(int id_usuario_login = 0, int id = 0, string descricao = "", int id_usuario = 0, int id_tipo_produto = 0, int id_situacao = 0, string oferta = "", 
            ...
            using (NpgsqlConnection conn = new NpgsqlConnection(Constantes.string_conexao))
            {
                ...
                try
                {
                    ...
                    if (conn.State == ConnectionState.Open)
                    {
                        ...
                        {
                            query_campos = query_campos + "d.id_usuario, u.nome nome_usuario, u.email email_usuario, ";
                        }

                        if (exportar == Constantes.NAO)
                        {
                            query_campos = query_campos + "tp.icone icone_tp_produto, ";
                        }
        ...
        public object Incluir_desejo( string descricao = "", int id_usuario = 0, int id_tipo_produto = 0, int id_situacao = 0)
        {
            object result = null;
        ...
        public object Excluir_desejo(int id = 0)
        {
            object result = null;
        ...
        public object Atualizar_desejo(int id = 0, string descricao = "", int id_usuario = 0, int id_tipo_produto = 0, int id_situacao = 0)
        {
            object result = null;
        ...
        public object Atualizar_situacao_desejo(int id = 0, int id_situacao = 0)
        {
            object result = null;
