...
{
    public class SituacoesRepository 
    {
        IConfiguration configuration;
        public SituacoesRepository(IConfiguration _configuration)
        {
        ...
        public object Consultar_situacao(int id = 0, string descricao = "", string contratos = "", string usuarios = "", string desejos = "", string faturas = "", string produtos = "", string ofertas = "", string origem = "")
        {
            object result = null;
